...
- Windows: [Jira-Timesheet-Free-Setup-1.0.0.exe](https://github.com/adamczyrek/jira-timesheet-free/blob/main/releases/Jira%20Timesheet%20Free-Setup-1.0.0.exe)
- macOS: `Jira-Timesheet-Free-1.0.0.dmg` (coming soon, if you have Mac, please build and create a PR)
